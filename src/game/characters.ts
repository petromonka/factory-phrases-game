...
export const CHARACTERS = [
  { id: "security-serhii", name: "Охоронець Сергій", room: "Прохідна", phrase: "Він мені одразу не понравився як тіко я його побачив", objectId: "npc-security", spriteKey: "npc-security" },
  { id: "it-vasyl", name: "Василь", room: "Кабінет ІТ", phrase: "Дімона нема — поїхав кудись і казав, зараз буде", objectId: "npc-it", spriteKey: "npc-vasyl-tall" },
